...
export default async function PartnerUsersPage({ searchParams = {} }) {
  if (await isUserRoleRestricted(UserRoles.PartnerAdmin)) notFound();
  ...
  return (
    <>
      ...
      />
      <InviteUserModal partnerId={users[0].partner_id} />
    </>
  );
}
